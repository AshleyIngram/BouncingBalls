...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return BowlingBall; });\n/* harmony import */ var _Ball__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Ball */ \"./src/Ball.js\");\n\r\n\r\n/**\r\n * A Bowling Ball. Bigger and Heavier, should bounce less.\r\n */\r\nclass BowlingBall extends _Ball__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n  /**\r\n   * Create an instance of a BowlingBall object\r\n   *\r\n   * @param {Scene} scene The scene object, containing global helpers\r\n   * to help with rendering (e.g. adjusting the X/Y offsets)\r\n   * @param {number} initialX The X position the ball should be initially\r\n   * created at\r\n   * @param {number} initialY The Y position the ball should be initially\r\n   * created at\r\n   * @param {number} initialAngle The initial angle of travel for the ball\r\n   * @param {number} initialVelocity How fast the ball is initially moving\r\n   */\r\n  constructor(scene, initialX, initialY, initialAngle, initialVelocity) {\r\n    super(scene, initialX, initialY, initialAngle, initialVelocity);\r\n\r\n    this.dampeningFactor = 0.2;\r\n    this.radius = 21;\r\n  }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/BowlingBall.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return TennisBall; });\n/* harmony import */ var _Ball__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Ball */ \"./src/Ball.js\");\n\r\n\r\n/**\r\n * A Tennis Ball. The same as the default ball, except in colour\r\n */\r\nclass TennisBall extends _Ball__WEBPACK_IMPORTED_MODULE_0__[\"default\"] {\r\n  /**\r\n   * Create an instance of a TennisBall object\r\n   *\r\n   * @param {Scene} scene The scene object, containing global helpers\r\n   * to help with rendering (e.g. adjusting the X/Y offsets)\r\n   * @param {number} initialX The X position the ball should be initially\r\n   * created at\r\n   * @param {number} initialY The Y position the ball should be initially\r\n   * created at\r\n   * @param {number} initialAngle The initial angle of travel for the ball\r\n   * @param {number} initialVelocity How fast the ball is initially moving\r\n   */\r\n  constructor(scene, initialX, initialY, initialAngle, initialVelocity) {\r\n    super(scene, initialX, initialY, initialAngle, initialVelocity);\r\n\r\n    this.color = 'c9f364';\r\n  }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/TennisBall.js?");
